...
function createPost(title, description, category, format) {
    ...
    else if (format == 'text' && description.length > 2000) return 'description_error';
...
jQuery(document).ready(function() {
    ...
    $('.top-menu>li:first-of-type').not('.new-squawk-li').click(function(event) {
        event.preventDefault();
    ...
    $('.new-squawk-li').click(function(e){
    	e.preventDefault();
    	if (window.localStorage.getItem("user_token") == -1) {
    ...
    $("#add-new").click(function(e) {
        ...
        else if (response == "description_error") alert('Description must be less than 2000 characters');
